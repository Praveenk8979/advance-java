...
/*-------------------------Planning2----------------------------*/
	...
	@Override
	public boolean isPetitionNoexists(String writPatitionNumber)
	{
		if(!sessionFactory.getCurrentSession().createSQLQuery("Select writPatitionNumber from Law where writPatitionNumber='"+writPatitionNumber+"'").list().isEmpty())
			return true;
		return false;
	}

	@Override
	public boolean isSysexists(String writPatitionNumber)
	{
		if(!sessionFactory.getCurrentSession().createSQLQuery("Select file_no from Systems where file_no='"+writPatitionNumber+"'").list().isEmpty())
			return true;
		return false;
	}
	...
	{   System.out.println("EM Retrieve Records:1");
		ArrayList<EM> records=new ArrayList<>();
	...
	{   System.out.println("EM2 Retrieve Records");
		ArrayList<EM2> records=new ArrayList<>();
	...
	public ArrayList<UE> retrieveUERecords(ArrayList<String> params) {
		 System.out.println("UE Retrieve Records");
			ArrayList<UE> records=new ArrayList<>();
			String q=null;
			if(!params.isEmpty())
			{
				for(String param:params)
	...
	public ArrayList<Law> retrieveLawRecords(ArrayList<String> params)
	{
		...
		ArrayList<Law> records=new ArrayList<>();
	...
	public ArrayList<Planning2> retrievePlanning2Records(ArrayList<String> params) {
		...
		ArrayList<Planning2> records=new ArrayList<>();
	...
	public ArrayList<Systems> retrieveSystemRecords(ArrayList<String> params) {
		...
		ArrayList<Systems> records=new ArrayList<>();
	...
	public ArrayList<ProjectTech> retrieveProjectTechRecords(String[] snos) {
		...
		ArrayList<ProjectTech> records=new ArrayList<>();
	...
	public ArrayList<EM3> retrieveEM3Records(String[] snos) {
		System.out.println("post method:1");
		ArrayList<EM3> records=new ArrayList<>();
		System.out.println("2");
		session=sessionFactory.getCurrentSession();
		for(String sno:snos)
