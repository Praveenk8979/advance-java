...
public class FileController {
	...
	public String uploadBulk(HttpServletRequest request, @RequestParam("csv") MultipartFile csv,
			@RequestParam("department") String department, @RequestParam("pdfLocation") String pdfLocation,
	...
	private String uploadFiles(HttpServletRequest request, MultipartFile csv, String department, String pdfLocation,
			boolean oracleCheck) throws IOException {
				...
				if (countLine == 0) {
					...
					if (!invalidLine) {
						...
						if (!invalidLine) {
							...
							if (department.equals("Residential") || department.equals("Abadi 6%")
									|| department.equals("Institutional") || department.equals("IT")
									|| department.equals("Group Housing") || department.equals("Builder")
									|| department.equals("Commercial") || department.equals("Industry")) {
								if (genAgePlanService.isAllotmentNoExists(data[7].trim(), "AllotmentNo"))
									duplicateFlage = true;
								else {
									if (new File(pdfLocation + "/" + data[7].trim() + "L.pdf").exists()
											|| new File(pdfLocation + "/" + data[7].trim() + "R.pdf").exists()
											|| new File(pdfLocation + "/" + data[7].trim() + " L.pdf").exists()
											|| new File(pdfLocation + "/" + data[7].trim() + " R.pdf").exists())
							...
							if (department.contains("_")) {
								...
								if (subDepartment.equals("Bank Statement") || subDepartment.equals("Loan")
										|| subDepartment.equals("Direct Salary")
										|| subDepartment.equals("Deputation Salary") || subDepartment.equals("TDS")
										|| subDepartment.equals("Labor Cass") || subDepartment.equals("Costing")
										|| subDepartment.equals("tax")) {
									if (subDepartment.equals("Bank Statement")) {
										if (proFinService.isFinExists(data[11].trim(), "AccountNo")
												|| proFinService.isFinExists(data[4].trim(), "PeriodOfStatement")) {
											duplicateFlage = true;
										} else {
											...
											} else if (new File(pdfLocation + "/" + data[4] + ".pdf").exists()) {
												System.out.println(pdfLocation + "/" + data[4] + "pdf");
									...
									if (subDepartment.equals("Loan")) {
										if (proFinService.isFinExists(data[11].trim(), "AccountNo")) {
											...
											if (new File(pdfLocation + "/" + data[11].trim() + "L.pdf").exists()
													|| new File(pdfLocation + "/" + data[11].trim() + "R.pdf").exists()
													|| new File(pdfLocation + "/" + data[11].trim() + " L.pdf").exists()
													|| new File(pdfLocation + "/" + data[11].trim() + " R.pdf")
															.exists())
									...
									} else if (subDepartment.equals("Direct Salary")
											|| subDepartment.equals("Deputation Salary") || subDepartment.equals("TDS")
											|| subDepartment.equals("Labor Cass") || subDepartment.equals("Costing")
											|| subDepartment.equals("tax")) {
										if (proFinService.isFinExists(data[2].trim(), "CodeNo"))
											...
											if (new File(pdfLocation + "/" + data[2].trim() + "L.pdf").exists()
													|| new File(pdfLocation + "/" + data[2].trim() + "R.pdf").exists()
													|| new File(pdfLocation + "/" + data[2].trim() + " L.pdf").exists()
													|| new File(pdfLocation + "/" + data[2].trim() + " R.pdf").exists())
							...
							if (department.equals("Project") || department.equals("Sewage")
									|| department.equals("Water")) {
								if (proFinService.isProExists(data[3].trim()))
									duplicateFlage = true;
								else {
									if (new File(pdfLocation + "/" + data[3].trim() + "L.pdf").exists()
											|| new File(pdfLocation + "/" + data[3].trim() + "R.pdf").exists()
											|| new File(pdfLocation + "/" + data[3].trim() + " L.pdf").exists()
											|| new File(pdfLocation + "/" + data[3].trim() + " R.pdf").exists())
							...
							if (department.equals("Planning(Residential)") || department.equals("Planning(Industry)")
									|| department.equals("Planning(Building NOC)")
									|| department.equals("Planning(Policies)")
									|| department.equals("Planning(Institutional)")) {
								if (department.equals("Planning(Residential)")) {
									...
									if (genAgePlanService.isAllotmentNo3Exists(data[6].trim(), "Institutional"))
										...
										if (new File(pdfLocation + "/" + data[6].trim() + "L.pdf").exists()
												|| new File(pdfLocation + "/" + data[6].trim() + " L.pdf").exists()
												|| new File(pdfLocation + "/" + data[6].trim() + "R.pdf").exists()
												|| new File(pdfLocation + "/" + data[6].trim() + " R.pdf").exists())
									...
									if (genAgePlanService.isAllotmentNo4Exists(data[5].trim(), "Building NOC"))
										...
										if (new File(pdfLocation + "/" + data[5].trim() + "L.pdf").exists()
												|| new File(pdfLocation + "/" + data[5].trim() + " L.pdf").exists()
												|| new File(pdfLocation + "/" + data[5].trim() + "R.pdf").exists()
												|| new File(pdfLocation + "/" + data[5].trim() + " R.pdf").exists())
							...
							if (department.equals("Land")) {
								if (new File(pdfLocation + "/" + data[8].trim() + "L.pdf").exists()
										|| new File(pdfLocation + "/" + data[8].trim() + " L.pdf").exists()
										|| new File(pdfLocation + "/" + data[8].trim() + "R.pdf").exists()
										|| new File(pdfLocation + "/" + data[8].trim() + " R.pdf").exists())
									uploadLandFiles(data, pdfLocation);
							}

							if (department.equals("EM3") || department.equals("HortiCulture")
									|| department.equals("Urban")) {
							...
							if (department.equals("Law")) {
								if (department.equals("Law")) {
									if (emlService.isPetitionNoexists(data[3].trim()))
										duplicateFlage = true;
									else {
										...
										if (new File(pdfLocation + "/" + data[3].trim() + "L" + ".pdf").exists()
											...
											try {
												...
												errors = errors.append(e.getLocalizedMessage());
												invalidLine = true;
											}
										else {
											flage = "";
							...
							if (department.equals("Systems")) {
								if (emlService.isSysexists(data[4].trim()))
									...
									if (new File(pdfLocation + "/" + data[4].trim() + "L" + ".pdf").exists()
											|| new File(pdfLocation + "/" + data[4].trim() + "R" + ".pdf").exists())
	...
	private void uploadGeneralFiles(String[] data, String pdfLocation, boolean oracleCheck, String department) {
		...
		new File(pdfLocation + "/" + data[7].trim() + "L.pdf")
				.renameTo(new File(general.getLocation() + data[7].trim() + "L.pdf"));

		new File(pdfLocation + "/" + data[7].trim() + "R.pdf")
				.renameTo(new File(general.getLocation() + data[7].trim() + "R.pdf"));
	...
	private void uploadFinanceFiles(String subDepartment, String[] data, String pdfLocation) {
		...
		new File(pdfLocation + "/" + data[11].trim() + ".pdf")
				.renameTo(new File(fc.getLocation() + data[11].trim() + ".pdf"));
	...
	private void uploadFinanceaFiles(String subDepartment, String[] data, String pdfLocation) {
		...
		fc.setLocation(utils.generateFilePath());
		new File(pdfLocation + "/" + data[4].trim() + ".pdf")
				.renameTo(new File(fc.getLocation() + data[4].trim() + ".pdf"));
		proFinService.insertOrUpdateFin(fc);
	}
	...
	private void uploadFinance1Files(String subDepartment, String[] data, String pdfLocation) {
		...
		fc.setAccountNo(data[11].trim());
		fc.setLocation(utils.generateFilePath());
		new File(pdfLocation + "/" + data[11].trim() + "L.pdf")
				.renameTo(new File(fc.getLocation() + data[11].trim() + "L.pdf"));
		new File(pdfLocation + "/" + data[11].trim() + "R.pdf")
				.renameTo(new File(fc.getLocation() + data[11].trim() + "R.pdf"));
		new File(pdfLocation + "/" + data[11].trim() + " L.pdf")
				.renameTo(new File(fc.getLocation() + data[11].trim() + "L.pdf"));
		new File(pdfLocation + "/" + data[11].trim() + " R.pdf")
				.renameTo(new File(fc.getLocation() + data[11].trim() + "R.pdf"));
	...
	private void uploadFinance2Files(String subDepartment, String[] data, String pdfLocation) {
		...
		fc.setLocation(utils.generateFilePath());
		new File(pdfLocation + "/" + data[2].trim() + "L.pdf")
				.renameTo(new File(fc.getLocation() + data[2].trim() + "L.pdf"));
		new File(pdfLocation + "/" + data[2].trim() + "R.pdf")
				.renameTo(new File(fc.getLocation() + data[2].trim() + "R.pdf"));
		new File(pdfLocation + "/" + data[2].trim() + " L.pdf")
				.renameTo(new File(fc.getLocation() + data[2].trim() + "L.pdf"));
		new File(pdfLocation + "/" + data[2].trim() + " R.pdf")
				.renameTo(new File(fc.getLocation() + data[2].trim() + "R.pdf"));
	...
	private void uploadProjectFiles(String[] data, String pdfLocation) {
		...
		new File(pdfLocation + "/" + data[3].trim() + "L.pdf")
				.renameTo(new File(project.getLocation() + data[3].trim() + "L.pdf"));
		new File(pdfLocation + "/" + data[3].trim() + "R.pdf")
				.renameTo(new File(project.getLocation() + data[3].trim() + "R.pdf"));
		new File(pdfLocation + "/" + data[3].trim() + " L.pdf")
				.renameTo(new File(project.getLocation() + data[3].trim() + "L.pdf"));
		new File(pdfLocation + "/" + data[3].trim() + " R.pdf")
				.renameTo(new File(project.getLocation() + data[3].trim() + "R.pdf"));
	...
	private void uploadPlanningFiles(String subDepartment, String[] data, String pdfLocation) {
		...
		if (subDepartment.equals("Industry") || subDepartment.equals("Institutional")) {
			...
			new File(pdfLocation + "/" + data[6].trim() + "L.pdf")
					.renameTo(new File(planning.getLocation() + data[6].trim() + "L.pdf"));
			new File(pdfLocation + "/" + data[6].trim() + " L.pdf")
					.renameTo(new File(planning.getLocation() + data[6].trim() + "L.pdf"));
			new File(pdfLocation + "/" + data[6].trim() + "R.pdf")
					.renameTo(new File(planning.getLocation() + data[6].trim() + "R.pdf"));
			new File(pdfLocation + "/" + data[6].trim() + " R.pdf")
					.renameTo(new File(planning.getLocation() + data[6].trim() + "R.pdf"));
		} else if (subDepartment.equals("Planning(Industry)") || subDepartment.equals("Residential")
				|| subDepartment.equals("Planning(Group Housing)")) {
			planning.setDoa("NA");
			planning.setDoc("NA");
			new File(pdfLocation + "/" + data[7].trim() + "L.pdf")
					.renameTo(new File(planning.getLocation() + data[7].trim() + "L.pdf"));
			new File(pdfLocation + "/" + data[7].trim() + " L.pdf")
					.renameTo(new File(planning.getLocation() + data[7].trim() + "L.pdf"));
			new File(pdfLocation + "/" + data[7].trim() + "R.pdf")
					.renameTo(new File(planning.getLocation() + data[7].trim() + "R.pdf"));
			new File(pdfLocation + "/" + data[7].trim() + " R.pdf")
					.renameTo(new File(planning.getLocation() + data[7].trim() + "R.pdf"));
			...
			new File(pdfLocation + "/" + data[5].trim() + "L.pdf")
					.renameTo(new File(planning.getLocation() + data[5].trim() + "L.pdf"));
			new File(pdfLocation + "/" + data[5].trim() + " L.pdf")
					.renameTo(new File(planning.getLocation() + data[5].trim() + "L.pdf"));
			new File(pdfLocation + "/" + data[5].trim() + "R.pdf")
					.renameTo(new File(planning.getLocation() + data[5].trim() + "R.pdf"));
			new File(pdfLocation + "/" + data[5].trim() + " R.pdf")
					.renameTo(new File(planning.getLocation() + data[5].trim() + "R.pdf"));
		}
	...
	private void uploadEMFiles(String[] data, String pdfLocation) {
		...
		new File(pdfLocation + "/" + data[3].trim() + "L.pdf")
				.renameTo(new File(em.getLocation() + data[3].trim() + "L.pdf"));
		new File(pdfLocation + "/" + data[3].trim() + " L.pdf")
				.renameTo(new File(em.getLocation() + data[3].trim() + "L.pdf"));
		new File(pdfLocation + "/" + data[3].trim() + "R.pdf")
				.renameTo(new File(em.getLocation() + data[3].trim() + "R.pdf"));
		new File(pdfLocation + "/" + data[3].trim() + " R.pdf")
				.renameTo(new File(em.getLocation() + data[3].trim() + "R.pdf"));
	}
	...
	private void uploadLandFiles(String[] data, String pdfLocation) {
		...
		new File(pdfLocation + "/" + data[8].trim() + "L.pdf")
				.renameTo(new File(em.getLocation() + data[8].trim() + "L.pdf"));
		new File(pdfLocation + "/" + data[8].trim() + " L.pdf")
				.renameTo(new File(em.getLocation() + data[8].trim() + "L.pdf"));
		new File(pdfLocation + "/" + data[8].trim() + "R.pdf")
				.renameTo(new File(em.getLocation() + data[8].trim() + "R.pdf"));
		new File(pdfLocation + "/" + data[8].trim() + " R.pdf")
				.renameTo(new File(em.getLocation() + data[8].trim() + "R.pdf"));
	}
	...
	private void uploadLawFiles(String[] data, String pdfLocation) {
		...
		law.setDepartment(data[1]);
		
		law.setCourtName(data[2]);
		law.setWritPatitionNumber(data[3].trim());
		
		law.setYear(data[4]);
		law.setSubject(data[5]);
		
		law.setAdvocateName(data[6]);
		law.setRelatedDepartment(data[7]);
	
		law.setSector(data[8]);
		law.setOpaFTS(data[9]);
		
		
		law.setLocation(utils.generateFilePath());// ????????
		
		// move PDF file
		boolean lFlag = new File(pdfLocation + "\\" + data[3].trim() + "L.pdf")
				.renameTo(new File(law.getLocation() + data[3].trim() + "L.pdf"));

		boolean rFlag = new File(pdfLocation + "\\" + data[3].trim() + "R.pdf")
				.renameTo(new File(law.getLocation() + data[3].trim() + "R.pdf"));
		if (!lFlag || !rFlag) {
			throw new RuntimeException("\n Writ Patition Number:. " + law.getWritPatitionNumber() + " PDF Access failed or PDF not found");
		}

		// count pages
		law.setNoOfNoteeing(countPdfPages(law.getLocation() + data[3].trim() + "L.pdf"));
		law.setNoOfCoss(countPdfPages(law.getLocation() + data[3].trim() + "R.pdf"));

		int totalPage = Integer.valueOf(law.getNoOfNoteeing()) + Integer.valueOf(law.getNoOfCoss());
		law.setTotalPages(Integer.toString(totalPage));
...
//	
	...
	private void uploadProjectTechFiles(String[] data, String pdfLocation) {
		...
		new File(pdfLocation + "/" + data[2].trim() + ".pdf")
				.renameTo(new File(pt.getLocation() + data[2].trim() + ".pdf"));
	}
	...
	private void uploadSystemFiles(String[] data, String pdfLocation) {
		...
		// new File(pdfLocation+"/"+data[4].trim()+".pdf").renameTo(new
		// File(sy.getLocation()+data[4].trim()+".pdf"));

		new File(pdfLocation + "/" + data[4].trim() + "L.pdf")
				.renameTo(new File(sy.getLocation() + data[4].trim() + "L.pdf"));
		new File(pdfLocation + "/" + data[4].trim() + "R.pdf")
				.renameTo(new File(sy.getLocation() + data[4].trim() + "R.pdf"));
		new File(pdfLocation + "/" + data[4].trim() + " L.pdf")
				.renameTo(new File(sy.getLocation() + data[4].trim() + "L.pdf"));
		new File(pdfLocation + "/" + data[4].trim() + " R.pdf")
				.renameTo(new File(sy.getLocation() + data[4].trim() + "R.pdf"));
	...
	private void uploadMarketingFiles(String[] data, String pdfLocation) {
		...
		// new File(pdfLocation+"/"+data[6].trim()+"L.pdf").renameTo(new
		// File(makt.getLocation()+data[6].trim()+"L.pdf"));

		new File(pdfLocation + "/" + data[6].trim() + "L.pdf")
				.renameTo(new File(makt.getLocation() + data[6].trim() + "L.pdf"));
		new File(pdfLocation + "/" + data[6].trim() + "R.pdf")
				.renameTo(new File(makt.getLocation() + data[6].trim() + "R.pdf"));
		new File(pdfLocation + "/" + data[6].trim() + " L.pdf")
				.renameTo(new File(makt.getLocation() + data[6].trim() + "L.pdf"));
		new File(pdfLocation + "/" + data[6].trim() + " R.pdf")
				.renameTo(new File(makt.getLocation() + data[6].trim() + "R.pdf"));
	...
	private void uploadHealthFiles(String[] data, String pdfLocation) {
		...
		// new File(pdfLocation+"/"+data[3].trim()+"L.pdf").renameTo(new
		// File(makt.getLocation()+data[3].trim()+"L.pdf"));

		new File(pdfLocation + "/" + data[3].trim() + "L.pdf")
				.renameTo(new File(health.getLocation() + data[3].trim() + "L.pdf"));
		new File(pdfLocation + "/" + data[3].trim() + "R.pdf")
				.renameTo(new File(health.getLocation() + data[3].trim() + "R.pdf"));
		new File(pdfLocation + "/" + data[3].trim() + " L.pdf")
				.renameTo(new File(health.getLocation() + data[3].trim() + "L.pdf"));
		new File(pdfLocation + "/" + data[3].trim() + " R.pdf")
				.renameTo(new File(health.getLocation() + data[3].trim() + "R.pdf"));
	...
	private void uploadHRFiles(String[] data, String pdfLocation) {
		...
		hr.setYear(data[2]);
		hr.setFileCode(data[3]);

		hr.setFileNo(data[4].trim());
		hr.setFileSubject(data[5]);

		hr.setEmployeeCode(data[6]);
		hr.setEmployeeName(data[7]);

		hr.setEmployeeCategory(data[8]);
		hr.setEmployeeDesignation(data[9]);

		hr.setEmployeeDob(data[10]);
		hr.setEmployeeDoj(data[11]);

		hr.setOpaFts(data[12]);

		hr.setLocation(utils.generateFilePath());

		// move PDF file
		boolean lFlag = new File(pdfLocation + "\\" + data[4].trim() + "L.pdf")
				.renameTo(new File(hr.getLocation() + data[4].trim() + "L.pdf"));

		boolean rFlag = new File(pdfLocation + "\\" + data[4].trim() + "R.pdf")
				.renameTo(new File(hr.getLocation() + data[4].trim() + "R.pdf"));
		if (!lFlag || !rFlag) {
			throw new RuntimeException("\n File No:. " + hr.getFileNo() + " PDF Access failed or PDF not found");
		}

		// count pages
		hr.setNoOfNoteeing(countPdfPages(hr.getLocation() + data[4].trim() + "L.pdf"));
		hr.setNoOfCoss(countPdfPages(hr.getLocation() + data[4].trim() + "R.pdf"));

		int totalPage = Integer.valueOf(hr.getNoOfNoteeing()) + Integer.valueOf(hr.getNoOfCoss());
		hr.setTotalPages(Integer.toString(totalPage));

		hrs.insertOrUpdateHRRecord(hr);

	}

	private String countPdfPages(String pdfPath) {
	...
	private void uploadUEFiles(String[] data, String pdfLocation) {
		...
		new File(pdfLocation + "/" + data[3].trim() + "L.pdf")
				.renameTo(new File(ue.getLocation() + data[3].trim() + "L.pdf"));
		new File(pdfLocation + "/" + data[3].trim() + "R.pdf")
				.renameTo(new File(ue.getLocation() + data[3].trim() + "R.pdf"));
		new File(pdfLocation + "/" + data[3].trim() + " L.pdf")
				.renameTo(new File(ue.getLocation() + data[3].trim() + "L.pdf"));
		new File(pdfLocation + "/" + data[3].trim() + " R.pdf")
				.renameTo(new File(ue.getLocation() + data[3].trim() + "R.pdf"));
	...
	private void uploadPlanning2Files(String[] data, String pdfLocation) {
		...
		new File(pdfLocation + "/" + data[2].trim() + ".pdf")
				.renameTo(new File(p.getLocation() + data[2].trim() + ".pdf"));
	}
	...
	public String viewFile(HttpServletRequest request, HttpServletResponse response,
			@RequestParam("department") String department, @RequestParam("id") String id,
			@RequestParam("sno") String sno, @RequestParam("prFlage") String prFlage,
			@RequestParam("name") String alloteeName) throws IOException {
		...
		if (prFlage != null && prFlage.equals("null")) {
			if (department.equals("General") || department.equals("Planning")) {
				...
				count = FileUtils.viewFile(id + "L.pdf", webLocation, location, modelInitializer.getId(request) + ",v",
						false);
				count = count + "<@>" + FileUtils.viewFile(id + "R.pdf", webLocation, location,
						modelInitializer.getId(request) + ",v", false);
			}
			if (department.equals("Finance") || department.equals("Project")) {
				...
				if (department.equals("Finance")) {
					if (new File(location + "/" + alloteeName + ".pdf").exists()) {
						count = FileUtils.viewFile(alloteeName + ".pdf", webLocation, location,
								modelInitializer.getId(request) + ",v", false);
						commonService.insertLogs(uId,
								"Viewed file of " + department + " with Id:" + id + " & name:" + alloteeName);
						out.println(alloteeName + "<@>" + count);

						return null;
					} else if (new File(location + "/" + id + ".pdf").exists()) {
						count = FileUtils.viewFile(id + ".pdf", webLocation, location,
								modelInitializer.getId(request) + ",v", false);
						commonService.insertLogs(uId,
								"Viewed file of " + department + " with Id:" + id + " & name:" + alloteeName);
						...
						count = FileUtils.viewFile(id + "L.pdf", webLocation, location,
								modelInitializer.getId(request) + ",v", false);
						count = count + "<@>" + FileUtils.viewFile(id + "R.pdf", webLocation, location,
								modelInitializer.getId(request) + ",v", false);
					}
			...
			commonService.insertLogs(uId,
					"Printed file of " + department + " with Id:" + id + " & name:" + alloteeName);
			out.print(id);
		}
		return null;
	}
	...
	public String downloadFile(ModelMap model, HttpServletRequest request, HttpServletResponse response,
			@RequestParam("department") String department, @RequestParam("id") String id,
		...
		if (department.equals("General") || department.equals("Planning")) {
			location = genAgePlanService.getLocation(department, Integer.parseInt(sno));
			FileUtils.downloadFile(response, id, location, true,
					request.getServletContext().getRealPath("/") + "staticResources/pdfs/",
					modelInitializer.getId(request));
		}
		if (department.equals("Finance") || department.equals("Project")) {
			location = proFinService.getProFinLocation(department, Integer.parseInt(sno));
			if (department.equals("Finance")) {
				...
				if (statement != "undefined" && subdepartment.equals("Bank Statement")) {
					if (new File(location + "/" + statement.trim() + ".pdf").exists()) {
						FileUtils.downloadFile(response, statement, location, false,
								request.getServletContext().getRealPath("/") + "staticResources/pdfs/",
								modelInitializer.getId(request));
					} else
						FileUtils.downloadFile(response, id, location, false,
								request.getServletContext().getRealPath("/") + "staticResources/pdfs/",
								modelInitializer.getId(request));
				} else {
					FileUtils.downloadFile(response, id, location, true,
		...
		if (department.equals("EM3") || department.equals("HortiCulture") || department.equals("Urban")) {
			location = proFinService.getProFinLocation(department, Integer.parseInt(sno));
			if (department.equals("Law"))
				FileUtils.downloadFile(response, id + ".pdf", location, false,
						request.getServletContext().getRealPath("/") + "staticResources/pdfs/",
						modelInitializer.getId(request));
			else
				FileUtils.downloadFile(response, id, location, true,
		...
		if (department.equals("Systems") || department.equals("UE")) {
			location = proFinService.getProFinLocation(department, Integer.parseInt(sno));
			if (department.equals("Systems"))
				FileUtils.newDownloadFile(response, id + ".pdf", location, true,
						request.getServletContext().getRealPath("/") + "staticResources/pdfs/",
						modelInitializer.getId(request));
			else
				FileUtils.newDownloadFile(response, id, location, true,
						request.getServletContext().getRealPath("/") + "staticResources/pdfs/",
						modelInitializer.getId(request));
		}
	...
	public String updateFile(ModelMap model, HttpServletRequest request, @RequestParam("department") String department,
			@RequestParam("sno") String sno) {
	...
	public String deleteViewFile(ModelMap model, HttpServletRequest request,
		...
		if (department.equals("General")) {
			...
			if (modelInitializer.getIdModule(request).equals("Super Administrator")
				...
				model.addAttribute("sectors",
						commonService.getAllSectors(params.get(0).substring(0, params.get(0).indexOf("@"))));
			else
				model.addAttribute("sectors",
						commonService.getAllSectors(params.get(0).substring(0, params.get(0).indexOf("@")), uId));
		}
		if (department.equals("Finance"))
	...
	public String generateReport(HttpServletRequest request, HttpServletResponse response,
			@RequestParam("department") String department, @RequestParam("sno") String sno) {
		String uId = modelInitializer.getId(request);
		if (uId == null)
			return "error";
		...
		if (department.equals("Law")) {
			...
			ArrayList<Law> record = new ArrayList<>();
		...
		if (department.equals("EM")) {
			...
			ArrayList<EM> record = new ArrayList<>();
		...
		if (department.equals("UE")) {
			...
			ArrayList<UE> record = new ArrayList<>();
		...
		if (department.equals("EM3") || department.equals("HortiCulture") || department.equals("Urban")) {
			ArrayList<EM3> record = new ArrayList<>();
		...
		if (department.equals("ProjectTech")) {
			ArrayList<ProjectTech> record = new ArrayList<>();
		...
		if (department.equals("Systems")) {
			ArrayList<Systems> record = new ArrayList<>();
		...
		if (department.equals("Marketing")) {
			ArrayList<Marketing> record = new ArrayList<>();
		...
		if (department.equals("Health")) {
			ArrayList<Health> record = new ArrayList<>();
	...
	public String generateReport(HttpServletRequest request, HttpServletResponse response,
		...
		if (snos != null && snos.length > 0) {
			...
			if (department.equals("Marketing")) {
				System.out.println("MarketingReport:1:post method");
				FileUtils.generateMarketingReport(marketingService.retrieveMarketingRecords(params), location,
						response);
			}
	...
	public String csvTemplate(HttpServletRequest request, @RequestParam("department") String department,
	...
	public static void downloadFile1(String fileLocation, String fileName, HttpServletResponse response,
			boolean waterFlage) {
