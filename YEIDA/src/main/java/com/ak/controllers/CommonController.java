...
public class CommonController {
	...
	public String uploadManual(ModelMap model, HttpServletRequest request,
	...
	public String retrieve(ModelMap model, HttpServletRequest request,
	...
	public String getHelp(HttpServletRequest request, HttpServletResponse response, @RequestParam("help") String help,
