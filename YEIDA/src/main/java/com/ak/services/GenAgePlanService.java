...
/*
 * @Override public Planning retrievePlanRecord(int sno) { return
 * genAgePlanDao.retrievePlanRecord(sno); }
 *
 * @Override public Planning retrievePlanRecord(int sno) { for(Iterator
 * it=sessionFactory.getCurrentSession().
 * createQuery("From Planning planning where planning.sno="+sno+"").list().
 * iterator();it.hasNext();) return (Planning)it.next(); return null; }
 *
 *
 */